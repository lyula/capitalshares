                ...
                <div class="pcoded-wrapper">
                    ...
                    <div class="pcoded-content">
                        ...
                        <div class="pcoded-inner-content">
                            ...
                            <h5> Investments history</h5>
                            <div id="income-analysis" style="height:100px">
                                <div class="card card-block p-b-0">
                                    <div class="table-responsive" style="overflow-x: auto;">
                                        <table id="deposits-table" class="table table-hover m-b-0"
                                            style="min-width: 320px;">
                                            <thead>
                                                <tr>
                                                    <th style="min-width: 120px; padding: 4px;">Company</th>
                                                    <th style="min-width: 120px; padding: 4px;">Amount</th>
                                                    <th style="min-width: 120px; padding: 4px;">Pay Per Day</th>
                                                    <th style="min-width: 120px; padding: 4px;">Date invested</th>
                                                </tr>
                                            </thead>
                                            <?php
                                            ...
                                            if (isset($_SESSION['user_id'])) {
                                                // User is logged in, retrieve their user_id from the session
                                                $user_id = $_SESSION['user_id'];

                                                // Query to fetch investments history for the logged-in user
                                                $query = "SELECT company, amount, pay_per_day , date_invested FROM investments WHERE user_id = $user_id";
                                                ...
                                                if ($result) {
                                                    ...
                                                    if (mysqli_num_rows($result) > 0) {
                                                        // Loop through each row and display investments history
                                            
                                                        foreach ($result as $row => $value) {
                                                            $company_id = $value['company'];
                                                            $company_name = sqlValue("SELECT name FROM companies WHERE id='$company_id'");
                                                            echo "<tr>";
                                                            echo "<td>" . $company_name . "</td>";
                                                            echo "<td>" . number_format($value['amount']) . "</td>";
                                                            echo "<td>" . number_format($value['pay_per_day']) . "</td>";
                                                            echo "<td>" . $value['date_invested'] . "</td>";
                                                            echo "</tr>";
                                                        }
                                                    } else {
                                                        // No investment history found for the logged-in user
                                                        echo "<tr><td colspan='4'>No investment history found</td></tr>";
                                                    }
                                                } else {
