                                        ...
                                        <table id="deposits-table" class="table table-hover m-b-0"
                                            ...
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th style="min-width: 120px; padding: 4px;">Phone Number</th>
                                                    <th style="min-width: 120px; padding: 4px;">Date</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <?php
                                                ...
                                                if (isset($_SESSION['user_id'])) {
                                                    ...
                                                    $query = "SELECT amount, phone_number, date , status, mpesa_code , payment_refference FROM deposits WHERE user_id = $user_id";
                                                    ...
                                                    if ($result) {
                                                        ...
                                                        if (mysqli_num_rows($result) > 0) {
                                                            // Loop through each row and display deposit history
                                                            ...
                                                            // No deposit history found for the logged-in user
                                                            echo "<tr><td colspan='3'>No deposit history found</td></tr>";
                                                        }
                                                    } else {
