                        ...
                        <div class="pcoded-inner-content">
                            <div class="main-body">
                                <div class="page-wrapper">
                                    ...
                                    <div id="income-analysis" style="height:100px">Withdrawals history
                                            ...
                                            <table id="deposits-table" class="table table-hover m-b-0"
                                                ...
                                                <tbody>
                                                    ...
                                                    if (isset($_SESSION['user_id'])) {
                                                        ...
                                                        $query = "SELECT amount, phone_number, date FROM withdrawals WHERE user_id = $user_id";
                                                        ...
                                                        if ($result) {
                                                            ...
                                                            if (mysqli_num_rows($result) > 0) {
                                                                // Loop through each row and display withdrawals history
                                                                ...
                                                                // No withdrawal history found for the logged-in user
                                                                echo "<tr><td colspan='3'>No withdrawal history found</td></tr>";
                                                            }
                                                        } else {
